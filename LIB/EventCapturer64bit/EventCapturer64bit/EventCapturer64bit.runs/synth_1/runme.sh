...
HD_PWD='D:/GITEA/GitHub/ES/IP_cores/LIB/EventCapturer64bit/EventCapturer64bit/EventCapturer64bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EventCapturer64bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EventCapturer64bit.tcl
