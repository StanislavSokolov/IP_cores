...
HD_PWD='D:/GITEA/GitHub/ES/IP_cores/LIB/Inverter_3lvl/Inverter_3lvl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inverter_3lvl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inverter_3lvl_wrapper.tcl
