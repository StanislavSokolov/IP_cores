...
HD_PWD='D:/GITEA/GitHub/ES/IP_cores/LIB/AckCheckerBlock/AckCheckerBlock.runs/AckChecker_AckCheckerConcept_6_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AckChecker_AckCheckerConcept_6_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AckChecker_AckCheckerConcept_6_1.tcl
