...
synth_design -top AckChecker_wrapper -part xc7z020clg484-3


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef AckChecker_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file AckChecker_wrapper_utilization_synth.rpt -pb AckChecker_wrapper_utilization_synth.pb"
