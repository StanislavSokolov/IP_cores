...
HD_PWD='D:/GITEA/GitHub/ES/IP_cores/LIB/AckCheckerBlock/AckCheckerBlock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AckChecker_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AckChecker_wrapper.tcl
