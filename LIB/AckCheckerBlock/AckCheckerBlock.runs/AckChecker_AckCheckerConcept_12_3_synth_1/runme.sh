...
HD_PWD='D:/GITEA/GitHub/ES/IP_cores/LIB/AckCheckerBlock/AckCheckerBlock.runs/AckChecker_AckCheckerConcept_12_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AckChecker_AckCheckerConcept_12_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AckChecker_AckCheckerConcept_12_3.tcl
