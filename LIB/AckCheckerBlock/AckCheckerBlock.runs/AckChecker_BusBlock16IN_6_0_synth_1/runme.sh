...
HD_PWD='D:/GITEA/GitHub/ES/IP_cores/LIB/AckCheckerBlock/AckCheckerBlock.runs/AckChecker_BusBlock16IN_6_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AckChecker_BusBlock16IN_6_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AckChecker_BusBlock16IN_6_0.tcl
