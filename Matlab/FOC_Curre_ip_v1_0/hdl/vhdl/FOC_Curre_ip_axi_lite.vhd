-- -------------------------------------------------------------
-- 
-- File Name: D:\Projects\Matlab\IPcores\test\hdlsrc\hdlcoderFocCurrentFixptHdl\FOC_Curre_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FOC_Curre_ip_axi_lite
-- Source Path: FOC_Curre_ip/FOC_Curre_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY FOC_Curre_ip_axi_lite IS
...
END FOC_Curre_ip_axi_lite;


ARCHITECTURE rtl OF FOC_Curre_ip_axi_lite IS

  -- Component Declarations
  COMPONENT FOC_Curre_ip_addr_decoder
  ...
  COMPONENT FOC_Curre_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : FOC_Curre_ip_addr_decoder
    USE ENTITY work.FOC_Curre_ip_addr_decoder(rtl);

  FOR ALL : FOC_Curre_ip_axi_lite_module
    USE ENTITY work.FOC_Curre_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_Current_Command_tmp        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_Electrical_Position_tmp    : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_FOC_Curre_ip_addr_decoder_inst : FOC_Curre_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_Phase_Voltage_0 => read_Phase_Voltage_0,  -- sfix16_En8
              read_Phase_Voltage_1 => read_Phase_Voltage_1,  -- sfix16_En8
              read_Phase_Voltage_2 => read_Phase_Voltage_2,  -- sfix16_En8
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_Current_Command => write_Current_Command_tmp,  -- sfix16_En12
              write_Electrical_Position => write_Electrical_Position_tmp,  -- sfix16_En12
              write_Phase_Current_0 => write_Phase_Current_0,  -- sfix16_En12
              write_Phase_Current_1 => write_Phase_Current_1  -- sfix16_En12
              );

  u_FOC_Curre_ip_axi_lite_module_inst : FOC_Curre_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_Current_Command <= write_Current_Command_tmp;

  write_Electrical_Position <= write_Electrical_Position_tmp;
