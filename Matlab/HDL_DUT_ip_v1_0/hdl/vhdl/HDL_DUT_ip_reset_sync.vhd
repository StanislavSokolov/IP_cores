-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj2\hdlsrc\untitled\HDL_DUT_ip_reset_sync.vhd
...
-- Source Path: HDL_DUT_ip/HDL_DUT_ip_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HDL_DUT_ip_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END HDL_DUT_ip_reset_sync;


ARCHITECTURE rtl OF HDL_DUT_ip_reset_sync IS
