-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj2\hdlsrc\untitled\HDL_DUT_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: HDL_DUT_ip_axi_lite
-- Source Path: HDL_DUT_ip/HDL_DUT_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END HDL_DUT_ip_axi_lite;


ARCHITECTURE rtl OF HDL_DUT_ip_axi_lite IS

  -- Component Declarations
  COMPONENT HDL_DUT_ip_addr_decoder
  ...
  COMPONENT HDL_DUT_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : HDL_DUT_ip_addr_decoder
    USE ENTITY work.HDL_DUT_ip_addr_decoder(rtl);

  FOR ALL : HDL_DUT_ip_axi_lite_module
    USE ENTITY work.HDL_DUT_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_in1_tmp                    : std_logic_vector(3 DOWNTO 0);  -- ufix4
  SIGNAL write_in2_tmp                    : std_logic_vector(9 DOWNTO 0);  -- ufix10
...
BEGIN
  u_HDL_DUT_ip_addr_decoder_inst : HDL_DUT_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_out => read_out,  -- ufix11
              data_read => top_data_read,  -- ufix32
              write_in1 => write_in1_tmp,  -- ufix4
              write_in2 => write_in2_tmp  -- ufix10
              );

  u_HDL_DUT_ip_axi_lite_module_inst : HDL_DUT_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_in1 <= write_in1_tmp;

  write_in2 <= write_in2_tmp;
